...
export function createMapboxStreetsV6Style(e, t, o, a, r) {
  // Copied from https://openlayers.org/en/v6.13.0/examples/resources/mapbox-streets-v6-style.js
  var l = new t({ color: "" }),
    s = new o({ color: "", width: 1 }),
    n = new e({ fill: l }),
    i = new e({ fill: l, stroke: s }),
    d = new e({ stroke: s }),
    g = new e({ text: new r({ text: "", fill: l, stroke: s }) }),
    c = {};
  function b(t) {
    var o = c[t];
    return (
      o ||
        ((o = new e({
          image: new a({
            src: "https://unpkg.com/@mapbox/maki@4.0.0/icons/" + t + "-15.svg",
            imgSize: [15, 15],
